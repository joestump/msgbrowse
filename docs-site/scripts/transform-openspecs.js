...
function fixRelativePaths(content) {
  ...
  // This repo keeps ADRs at docs/adr/ -- specs reference them as
  // ../../../adr/NNNN-slug.md. On the site they live under /decisions/.
  content = content.replace(/\]\(\.\.\/\.\.\/\.\.\/adr\//g, '](../../decisions/');
  // docs/design/* is not part of the docs site; point at the repo.
